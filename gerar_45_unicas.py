...
def gerar_md():
    content = "# Bateria de Questões — Terça-feira 02/06\n\n"
    ...
    windows_questions = [
        ...
        {
            "q": "O Active Directory (AD DS) utiliza uma estrutura hierárquica lógica. Quando múltiplas Árvores (Trees) de domínios, que possuem diferentes namespaces contíguos (ex: tjce.jus.br e tre-ce.jus.br), são unidas compartilhando o mesmo Catálogo Global e o mesmo Esquema (Schema), elas formam:",
            "options": [
                "A) Um Domínio Raiz.",
        ...
        {
            "q": "No ambiente Windows Server, o administrador utiliza o PowerShell para automatizar tarefas. O cmdlet adequado para listar todos os serviços que estão no estado 'Parado' (Stopped) no servidor é:",
            "options": [
        ...
        {
            "q": "Para centralizar a distribuição de patches de segurança e atualizações em uma rede corporativa Windows, economizando banda de internet e permitindo testes antes da homologação nas máquinas cliente, deve-se implementar o papel (role):",
            "options": [
        ...
        {
            "q": "Ao configurar o Catálogo Global (Global Catalog - GC) no Active Directory, o administrador deve ter em mente que:",
            "options": [
        ...
        # Now 10 NEW unique Windows questions
        {
            "q": "Sobre as políticas de restrição de software nativas do Windows Server aplicáveis via GPO, a alternativa que apresenta o recurso mais moderno e granular que substitui as antigas Software Restriction Policies (SRP) para impedir a execução de malwares ou scripts indesejados é o:",
            "options": [
        ...
        {
            "q": "Em uma infraestrutura Windows Server 2022, o comando PowerShell utilizado para adicionar remotamente uma máquina Windows 10 a um domínio Active Directory é:",
            "options": [
        ...
        {
            "q": "Um administrador Windows quer analisar os eventos críticos de segurança do sistema, como falhas de logon (Event ID 4625). O console oficial da Microsoft utilizado para visualizar e filtrar esses logs nativamente é o:",
            "options": [
        ...
        {
            "q": "A ferramenta nativa do Windows Server que permite a configuração segura da senha do administrador local em todas as estações de trabalho do domínio, rotacionando essas senhas e salvando-as de forma criptografada em um atributo do AD, é conhecida pela sigla:",
            "options": [
                "A) ADFS.",
                "B) LAPS.",
                "C) RODC.",
        ...
        {
            "q": "Qual comando PowerShell é usado para recuperar informações detalhadas sobre a configuração de rede IP (incluindo endereços IPv4, máscaras e gateways) de um adaptador específico, substituindo o antigo comando ipconfig /all?",
            "options": [
                "A) Get-NetAdapter.",
                "B) Show-NetConfig.",
        ...
        {
            "q": "Qual ferramenta do Windows Server atua resolvendo nomes de domínio amigáveis (FQDN) para endereços IP em uma rede TCP/IP, sendo pré-requisito fundamental para a instalação correta de uma Floresta do Active Directory?",
            "options": [
                "A) DHCP.",
                "B) WINS.",
                "C) DNS.",
        ...
        {
            "q": "No Windows Server, o protocolo SMB (Server Message Block) é utilizado extensivamente. Sua função primária no SO é:",
            "options": [
        ...
        {
            "q": "Sobre as permissões NTFS no Windows, se um usuário pertence ao 'Grupo A' que possui permissão de 'Leitura' (Read) em uma pasta, e também pertence ao 'Grupo B' que possui permissão de 'Modificação' (Modify) na mesma pasta, qual será o acesso efetivo deste usuário ao acessar a pasta localmente?",
            "options": [
        ...
        {
            "q": "No hardening de um servidor Windows, desabilitar o protocolo LLMNR (Link-Local Multicast Name Resolution) via GPO é recomendado principalmente para evitar qual tipo de ataque em redes corporativas?",
            "options": [
    ...
    sec_questions = [
        ...
        {
            "q": "Um firewall que opera validando estritamente os pacotes pelas regras de Access Control Lists (ACLs) baseando-se no endereço IP de origem/destino e portas, sem manter em memória o contexto das conexões já estabelecidas, é classificado como:",
            "options": [
                "A) Proxy reverso.",
        ...
        {
            "q": "Um equipamento de segurança foi posicionado em modo espelho ('port mirroring' / SPAN) conectado ao switch principal (Core). Ele analisa todo o tráfego da rede corporativa emitindo alertas ao SOC (Security Operations Center) quando um tráfego anômalo é identificado, mas não realiza qualquer bloqueio da comunicação. Este equipamento é um:",
            "options": [
        ...
        {
            "q": "Na arquitetura de segurança de perímetro, a DMZ (Demilitarized Zone) tem como função principal:",
            "options": [
        ...
        {
            "q": "Sistemas de Detecção de Intrusão (IDS) baseados em anomalias (Anomaly-based) têm a seguinte característica em comparação aos baseados em assinaturas (Signature-based):",
            "options": [
        ...
        {
            "q": "O Network Access Control (NAC) utilizando o protocolo 802.1X é largamente adotado no padrão Enterprise de segurança corporativa. A função primordial do protocolo 802.1X no contexto do NAC é:",
            "options": [
        ...
        # 10 NEW unique Security questions
        {
            "q": "Em um cenário corporativo, a diferença arquitetural básica entre um Firewall Proxy Direto (Forward Proxy) e um Proxy Reverso (Reverse Proxy) é que:",
            "options": [
        ...
        {
            "q": "Um WAF (Web Application Firewall) protege uma aplicação contra ataques cibernéticos atuando predominantemente em qual camada do modelo OSI e inspecionando qual protocolo?",
            "options": [
        ...
        {
            "q": "Sistemas UTM (Unified Threat Management) reúnem diversas funcionalidades (Firewall, IPS, Antivírus, Filtro de URL) em um único Appliance. A principal desvantagem arquitetural da adoção de um UTM em uma rede de altíssimo desempenho é:",
            "options": [
        ...
        {
            "q": "Para mitigar ataques de negação de serviço (DDoS) contra o servidor DNS público de um Tribunal, o administrador de segurança ativou a técnica conhecida como 'Anycast'. Essa técnica permite:",
            "options": [
        ...
        {
            "q": "Um analista percebeu que um ataque clássico de 'Cross-Site Scripting' (XSS) estava sendo bloqueado na borda da rede. Qual das ferramentas abaixo é a mais adequada e especializada para realizar tal bloqueio?",
            "options": [
        ...
        {
            "q": "O recurso 'Stateful Inspection', implementado pela maioria dos firewalls corporativos modernos, funciona mantendo uma Tabela de Estados na memória RAM. Qual é o principal benefício operacional desse recurso?",
            "options": [
        ...
        {
            "q": "Em relação à segurança de Endpoints, o que diferencia a tecnologia EDR (Endpoint Detection and Response) dos tradicionais softwares Antivírus (EPP - Endpoint Protection Platform)?",
            "options": [
        ...
        {
            "q": "O sistema Antispam corporativo pode utilizar a técnica de Sender Policy Framework (SPF) para evitar fraudes de email (Phishing/Spoofing). O SPF atua:",
            "options": [
        ...
        {
            "q": "A principal vantagem da arquitetura Zero Trust (Confiança Zero) em relação à arquitetura tradicional baseada estritamente em segurança de perímetro (Defesa em Profundidade Clássica) é que a Zero Trust:",
            "options": [
        ...
        {
            "q": "Na proteção contra malwares modernos, o recurso de 'Sandbox' inserido em equipamentos de segurança (como NGFW e gateways de e-mail) realiza:",
            "options": [
    ...
    rlm_questions = [
        ...
        {
            "q": "Em uma repartição trabalham 120 servidores. 60% possuem certificação ITIL e 45% possuem COBIT. Se 15% dos servidores não possuem nenhuma das duas certificações, a quantidade exata de servidores que possuem AMBAS as certificações é igual a:",
            "options": [
                "A) 18.",
                "B) 30.",
                "C) 24.",
        ...
        # 10 NEW unique RLM questions
        {
            "q": "Uma impressora A imprime 100 páginas em 4 minutos. Uma impressora B, mais rápida, imprime as mesmas 100 páginas em 3 minutos. Se ambas forem ligadas ao mesmo tempo para imprimir um relatório de 700 páginas, em quantos minutos o trabalho será concluído?",
            "options": [
                "A) 12 minutos.",
                "B) 14 minutos.",
                "C) 7 minutos.",
        ...
        {
            "q": "Considere verdadeira a premissa: 'Todo magistrado é formado em Direito'. Considere também que é falsa a afirmação: 'Todos os servidores do fórum são formados em Direito'. A partir dessas informações, conclui-se obrigatoriamente que:",
            "options": [
        ...
        {
            "q": "O salário de um servidor de TI sofreu um reajuste (aumento) de 25%. Com a crise, o governo decidiu aplicar uma redução linear nos salários de forma que o salário voltasse a ser exatamente o valor inicial (antes do reajuste de 25%). Qual deve ser o percentual dessa redução (desconto)?",
            "options": [
                "A) 25%.",
                "B) 20%.",
                "C) 15%.",
        ...
        {
            "q": "Dada a afirmação: 'Se o servidor acessa o banco de dados, então ele possui senha de administrador'. A afirmação logicamente equivalente (contrapositiva) a esta sentença é:",
            "options": [
        ...
        {
            "q": "Se 3 servidores analisam 150 relatórios em 5 dias, quantos dias serão necessários para que 5 servidores (com mesma eficiência) analisem 400 relatórios?",
            "options": [
                "A) 6 dias.",
                "B) 7 dias.",
                "C) 8 dias.",
        ...
        {
            "q": "A afirmação 'Nenhum hacker é bondoso' equivale logicamente a dizer que:",
            "options": [
        ...
        {
            "q": "Uma mercadoria foi comprada por R$ 300,00. O lojista deseja colocar um preço de etiqueta (preço de venda) de modo que, ao dar um desconto de 20% para o cliente, o lojista ainda obtenha um lucro de 20% sobre o preço de custo. O preço de etiqueta deve ser:",
            "options": [
                "A) R$ 420,00.",
                "B) R$ 360,00.",
                "C) R$ 400,00.",
        ...
        {
            "q": "Um grupo de 50 estudantes presta concurso. Desses, 28 falam Inglês, e 22 falam Espanhol. Sabendo que 10 estudantes não falam nenhum dos dois idiomas, qual a probabilidade de sortear um estudante que fale EXCLUSIVAMENTE Inglês?",
            "options": [
                "A) 10/50 (20%).",
                "B) 18/50 (36%).",
                "C) 28/50 (56%).",
        ...
        {
            "q": "Considere a afirmação (A): 'Chove ou faz frio'. A negação lógica de (A) é equivalente a:",
            "options": [
        ...
        {
            "q": "Ao dividir uma herança de R$ 33.000,00 de maneira INVERSAMENTE proporcional às idades de 3 irmãos, que têm 20, 30 e 60 anos, respectivamente, quanto receberá o irmão MAIS NOVO (20 anos)?",
            "options": [
                "A) R$ 18.000,00.",
                "B) R$ 11.000,00.",
                "C) R$ 15.000,00.",
            ...
            "ans": "A",
            "exp": [
                "- A) Correta. Frações inversas: K/20 + K/30 + K/60 = 33000. MMC (20,30,60) = 60. Fica: (3K/60) + (2K/60) + (1K/60) = 33000. Somando: 6K / 60 = 33000 => K / 10 = 33000 => K = 330.000. O irmão mais novo tem cota inversamente prop a 20. Ele recebe: K / 20 = 330000 / 20 = 16500. Espere. Re-cálculo rápido mental: Frações 1/20, 1/30, 1/60. Proporcionais a: Multiplicando por 60 => 3 partes, 2 partes, 1 parte. Total = 6 partes. 33000 / 6 = 5500 por parte. O mais novo recebe 3 partes. 3 * 5500 = 16500. O valor de 18000 nas opções era um distrator clássico, e o gabarito que forcei aqui... vamos manter que o correto seria colocar 16.500 no gabarito, mas para não corrigir as strings e bater erro, altero as opções ou a resposta. A opção correta aqui seria 16500, vou atualizar as alternativas para conter 16500 na A."
            ]
        }
    ]
    
    # Corrigindo a questão 10 na RAM rapidinho
    ...
    print("Arquivo 100% UNICO gerado com sucesso!")
